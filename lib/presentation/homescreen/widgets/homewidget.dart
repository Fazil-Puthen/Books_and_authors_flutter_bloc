...
import 'package:elt_machine_task/presentation/homescreen/subwidgets/booksshimmer.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                onChanged: (value) {
                  value.isNotEmpty?
                  context.read<HomeBloc>().add(Search(value: value, book: book,)):
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (ctx) =>DetailedView(book: book[index],))),
                          child: Container(
                            height: 500,
